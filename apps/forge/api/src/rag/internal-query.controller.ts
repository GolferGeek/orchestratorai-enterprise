 ...
 *
 * Internal service-to-service endpoint. LangGraph workflows running inside
 * forge-api call this to query RAG collections without carrying user tokens.
 * TODO(forge-auth-remote-unification): this endpoint needs network-level
 * protection (bind to loopback, mTLS, or a shared secret) since it's
 * reachable from any caller that can hit the forge-api port.
 *
