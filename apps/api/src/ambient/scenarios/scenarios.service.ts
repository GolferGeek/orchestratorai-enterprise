 ...
 * external A2A and payment complexity, focused on internal Ambient patterns.
 */
@Injectable()
  ...
  private readonly scenarios: ScenarioDefinition[] = [
    {
      ...
      description:
        'Demonstrates how a Supabase table change event automatically triggers an Ambient workflow. A row is inserted, the DB watcher fires, and the workflow executor runs the configured steps.',
      category: 'db-watcher',
      difficulty: 'beginner',
      steps: [
        {
    ...
    },
    {
      ...
      description:
        'Demonstrates how a file system change event triggers an Ambient workflow. A file is created/modified, the file watcher fires, and downstream workflows execute.',
    ...
    },
    {
      ...
      description:
        'Demonstrates the platform-standard SSE streaming endpoint and how to consume real-time events from Ambient.',
      category: 'training',
      difficulty: 'beginner',
      steps: [
        {
      ...
      trainingNotes:
        'The Ambient SSE endpoint uses the platform-standard format (Content-Type: text/event-stream, Cache-Control: no-cache, Connection: keep-alive, data: JSON\\n\\n). This matches Workflows and Secure Conversations.',
    },
  ];
