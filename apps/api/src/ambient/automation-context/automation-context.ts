/**
 * Ambient Automation Context Contract
 *
 * Defines when and how Ambient system-triggered automation may originate
 ...
 * - Products receiving Ambient-originated context should validate it against
