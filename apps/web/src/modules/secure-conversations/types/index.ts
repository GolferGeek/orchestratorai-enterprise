/**
 * Secure Conversations Web Types
 *
 * All types inlined here so Secure Conversations does not depend on @agent-communication/shared-types.
 * Types reflect the external A2A gateway focus of Secure Conversations.
 */
...
// SecurityEnvelope — Secure Conversations-specific
