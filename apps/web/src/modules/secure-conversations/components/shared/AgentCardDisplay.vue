...
<template>
  <div class="card space-y-4">
    ...
    <JsonPayloadViewer v-if="(props.card as unknown as Record<string, unknown>).metadata" :data="(props.card as unknown as Record<string, unknown>).metadata as Record<string, unknown>" label="Metadata" />
  </div>
</template>
