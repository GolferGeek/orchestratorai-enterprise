      ...
      <div class="flex gap-4 h-[calc(100vh-280px)]">
        <div class="w-1/2 card overflow-y-auto">
          ...
          <EmptyState
            ...
            action-route="/app/secure-conversations/outbound"
          />
          ...
          <div v-else class="divide-y divide-gray-700">
            <button
              ...
              :class="[
                ...
                messagesStore.selectedMessage?.id === msg.id ? 'bg-gray-700/50 border-l-2 border-blue-500' : '',
              ]"
        ...
        <div class="w-1/2 card overflow-y-auto">
          <div v-if="messagesStore.selectedMessage" class="space-y-4">
            <div>
              <p class="text-xs text-gray-400 uppercase tracking-wider mb-2">Message Detail</p>
              <div class="grid grid-cols-2 gap-2 text-sm mb-3">
                ...
                <div>
                  ...
                  <p class="text-gray-200 font-mono">{{ messagesStore.selectedMessage.method }}</p>
                </div>
                <div>
                  <p class="text-xs text-gray-500">Status</p>
                  <p :class="statusColor(messagesStore.selectedMessage.status)">{{ messagesStore.selectedMessage.status }}</p>
                </div>
              </div>
            </div>
