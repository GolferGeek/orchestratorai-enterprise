  ...
  <div class="p-6">
    ...
    <div class="mb-8">
      <div class="flex items-center gap-3 mb-2">
        ...
        <h1 class="text-2xl font-bold text-white">Secure Conversations</h1>
    ...
    <div class="grid grid-cols-3 gap-4 mb-8">
      ...
      <div class="bg-gray-800 border border-gray-700 rounded-lg p-4">
        ...
        <p class="text-xs text-gray-500 mt-1">monitoring Secure Conversations stream</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4 mb-8">
      <router-link
        to="/app/secure-conversations/registry"
      ...
      <router-link
        to="/app/secure-conversations/inbound"
      ...
      <router-link
        to="/app/secure-conversations/outbound"
      ...
      <router-link
        to="/app/secure-conversations/security"
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-lg p-4">
      ...
      <div class="flex items-center gap-2 text-xs overflow-x-auto pb-2">
        ...
        <div class="flex flex-col items-center gap-1 flex-shrink-0">
          <div class="w-28 h-10 bg-blue-900 border border-blue-700 rounded flex items-center justify-center text-blue-300 text-center leading-tight px-1">Secure Validator</div>
        ...
        <div class="text-gray-600 flex-shrink-0">→</div>
        <div class="flex flex-col items-center gap-1 flex-shrink-0">
          <div class="w-24 h-10 bg-gray-700 rounded flex items-center justify-center text-gray-300 text-center leading-tight px-1">Workflows / Agents</div>
          <span class="text-gray-500">internal module</span>
        </div>
        <div class="text-gray-600 flex-shrink-0">←</div>
        <div class="flex flex-col items-center gap-1 flex-shrink-0">
