  ...
  <div class="p-6">
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-gray-400 text-sm mt-1">
          Registered external agents that Secure Conversations can communicate with — persisted in database
        </p>
      </div>
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-lg p-4 mb-6">
      ...
      <p class="mt-2 text-xs text-gray-500">
        Secure Conversations will fetch /.well-known/agent.json and register the agent's origin as trusted.
      </p>
    </div>
