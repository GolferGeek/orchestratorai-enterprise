    ...
    sections: [
      {
        heading: 'What it does',
        content:
          'Research Hub is a research aggregation agent. It scouts the web for articles matching configured topics, categorizes them, extracts key signals, and generates narrative summaries. Other agents can request research on specific topics through the A2A protocol.',
      },
      {
        heading: 'Capabilities',
        content:
          'Research Hub offers article scouting (finding relevant content), categorization (organizing by topic), narrative generation (AI-written summaries), and signal detection (identifying trending patterns). Each capability has independent pricing and can be invoked separately.',
      },
      {
        heading: 'In the playground',
        content:
    ...
    sections: [
      {
        heading: 'What it does',
        content:
          'Market Signals monitors content feeds, identifies trending topics, and maintains a processing queue for incoming articles. It acts as a market intelligence agent, surfacing what matters from the noise of information streams.',
      },
      {
        heading: 'Capabilities',
        content:
          'Market Signals offers feed management (configuring content sources), trend detection (identifying rising topics), queue processing (prioritizing and analyzing incoming content), and market analysis (synthesizing trends into actionable insights).',
      },
      {
    ...
    sections: [
      {
        heading: 'What it does',
        content:
          'Content Agent is a content creation agent. It takes research data from Research Hub and market analysis from Market Signals, then generates polished articles, reports, or summaries. It manages drafts through a review workflow before publication.',
      },
      {
        heading: 'Capabilities',
        content:
          'Content Agent offers topic discovery (finding content-worthy subjects), draft generation (AI-written first drafts), content refinement (editing and improving drafts), and multi-source synthesis (combining inputs from multiple agents into coherent output).',
      },
      {
