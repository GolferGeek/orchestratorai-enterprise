  ...
  <div class="detail-view">
    ...
    <div class="detail-body">
      ...
      <div class="content-area" v-else>
        ...
        <div class="status-banner" :class="databaseConnected ? 'banner-healthy' : 'banner-error'">
          <ion-icon :icon="databaseConnected ? checkmarkCircleOutline : alertCircleOutline" class="banner-icon" />
          <div class="banner-text">
            <span class="banner-title">{{ databaseConnected ? 'Connected' : 'Connection Error' }}</span>
...
const databaseConnected = computed(() => {
