        ...
        >
          <div class="agent-card-header">
            <div class="agent-title-group">
              <h3>{{ agent.name }}</h3>
              <span class="mono">{{ agent.slug }}</span>
            </div>
          ...
          <div class="agent-meta-grid">
            <div class="agent-meta-item">
              ...
              <span class="meta-value">{{ agent.agentType }}</span>
            </div>
            <div class="agent-meta-item">
              <span class="meta-label">Organization</span>
              <span class="meta-value mono">{{ agent.orgSlug }}</span>
            </div>
            <div class="agent-meta-item agent-meta-wide">
              <span class="meta-label">Updated</span>
              <span class="meta-value">{{ formatDate(agent.updatedAt) }}</span>
            </div>
          </div>
        </article>
      </div>
