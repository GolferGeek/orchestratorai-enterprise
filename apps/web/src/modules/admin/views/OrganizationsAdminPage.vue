      ...
      <div class="organizations-grid" v-if="!loading">
        ...
        >
          <div class="organization-card-header">
            ...
            <div class="organization-actions" @click.stop>
          ...
          <p v-if="org.description" class="organization-description">{{ org.description }}</p>
          <p v-else class="organization-description empty-description">No description</p>

          <div class="organization-meta-grid">
            <div class="organization-meta-item">
              <span class="meta-label">URL</span>
              <a v-if="org.url" :href="org.url" target="_blank" class="meta-value" @click.stop>{{ org.url }}</a>
              <span v-else class="meta-value muted">-</span>
            </div>
            <div class="organization-meta-item">
              <span class="meta-label">Created</span>
              <span class="meta-value">{{ formatDateTime(org.created_at) }}</span>
            </div>
          </div>
        </article>
      </div>
