/**
 * Admin API Service
 * HTTP client for Admin API calls through the unified platform API.
 * Handles LLM analytics, agent registry, observability, and system health.
 *
 * Architecture: Unified Web -> /api/admin -> unified Admin API modules -> planes/database
 */
