  ...
  <div class="detail-view">
    ...
    <div class="detail-body">
      ...
      <div class="documents-section">
        ...
        <div class="documents-grid" v-if="!documentsLoading && documents.length > 0">
          <article v-for="doc in documents" :key="doc.id" class="document-card">
            <div class="document-card-header">
              <div class="document-title-group">
                ...
                <div>
                  <h4>{{ doc.filename }}</h4>
                  <span class="mono small">{{ doc.contentType }}</span>
                </div>
              </div>
            ...
            <div class="document-meta-grid">
              <div class="document-meta-item">
                ...
                <span class="meta-value">{{ formatFileSize(doc.sizeBytes) }}</span>
              </div>
              <div class="document-meta-item">
                <span class="meta-label">Chunks</span>
                <span class="meta-value">{{ doc.chunkCount ?? '-' }}</span>
              </div>
              <div class="document-meta-item">
                <span class="meta-label">Tokens</span>
                <span class="meta-value">{{ doc.tokenCount ?? '-' }}</span>
              </div>
              <div class="document-meta-item">
                <span class="meta-label">Status</span>
                <span :class="['status-badge', `status-${doc.status}`]">{{ doc.status }}</span>
              </div>
              <div class="document-meta-item document-meta-wide">
