...
export const products: ProductCard[] = [
  {
    ...
    description:
      'A complete agent composition framework with working examples. Conversation agents, RAG retrieval, API integrations, and media generation are wired up and ready to customize.',
    features: [
      'Conversational AI agents',
      'RAG retrieval integration',
      'API and external connectors',
  ...
  },
  {
    ...
    description:
      'The foundation for demanding AI use cases. Working LangGraph workflows ship with the platform and can be extended for your domain-specific pipelines.',
    features: [
  ...
  },
  {
    ...
    description:
      'Infrastructure for ambient AI that watches your systems and acts. Database watchers, file triggers, and event-driven workflows are ready for your business rules.',
    features: [
  ...
  },
  {
    ...
    description:
      'Complete observability and control from day one: LLM analytics, RAG management, agent registry, entitlements, organizations, and users.',
    features: [
      'LLM usage analytics',
      'RAG pipeline management',
      'Agent registry and entitlements',
...
export const pricingTiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      'Full platform access across the core modules',
