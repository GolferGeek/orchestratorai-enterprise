...
export type ProductType = 'workflows' | 'agents' | 'ambient' | 'secure-conversations';
...
/** Resolve display name for an agent idea's product */
export function getAgentIdeaProductName(product: ProductType): string {
