        ...
        <div class="container">
          <div class="arch-inner">
            <div class="arch-text">
              ...
              <p class="section-sub">
                OrchestratorAI Enterprise is a unified platform web app and API backend
                with focused modules communicating through the A2A protocol. Every agent call carries
            ...
            <div class="arch-visual">
              <div class="arch-diagram">
                <div class="diagram-center">
                  <span>Platform</span>
                  <span class="diagram-port">6701 / 6700</span>
                </div>
...
import { aboutContent as content, products } from '@/modules/landing/data/landingConfig';

const archItems = [
  { port: '6701', product: 'OrchestratorAI', desc: 'Public landing, login, and authenticated shell' },
...
const diagramNodes = products.map(p => ({ name: p.name, icon: p.icon }));
</script>
