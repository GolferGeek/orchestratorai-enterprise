...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        path: 'app/workflows/legal-department',
        name: 'LegalDepartment',
        component: () => import('@/modules/workflows/views/legal-department/LegalDepartmentWorkspace.vue'),
        meta: { requiresAuth: true, title: 'Legal Department' },
      },
      {
      ...
      {
        path: 'app/workflows/legal-department/document-onboarding',
        name: 'LegalDocumentOnboarding',
        component: () => import('@/modules/workflows/views/legal-department/DocumentOnboardingPage.vue'),
        meta: { requiresAuth: true, title: 'Document Onboarding' },
      },
      {
        path: 'app/workflows/legal-department/contract-review',
        name: 'LegalContractReview',
        component: () => import('@/modules/workflows/views/legal-department/ContractReviewPage.vue'),
        meta: { requiresAuth: true, title: 'Contract Review' },
      },
      {
        path: 'app/workflows/legal-department/legal-research',
        name: 'LegalResearch',
        component: () => import('@/modules/workflows/views/legal-department/LegalResearchPage.vue'),
        meta: { requiresAuth: true, title: 'Legal Research' },
      },
      {
        path: 'app/workflows/legal-department/due-diligence',
        name: 'LegalDueDiligence',
        component: () => import('@/modules/workflows/views/legal-department/DueDiligenceRoomPage.vue'),
        meta: { requiresAuth: true, title: 'Due Diligence Room' },
      },
      {
        path: 'app/workflows/legal-department/compare',
        name: 'LegalCrossRoomComparison',
        component: () => import('@/modules/workflows/views/legal-department/CrossRoomComparisonPage.vue'),
        meta: { requiresAuth: true, title: 'Compare Rooms' },
      },
      {
        path: 'app/workflows/legal-department/dd/:parentJobId/memo/:memoJobId',
        name: 'LegalDealMemoWorkspace',
        component: () => import('@/modules/workflows/views/legal-department/DealMemoWorkspaceView.vue'),
        meta: { requiresAuth: true, title: 'Deal Memo' },
      },
      {
        path: 'app/workflows/legal-department/adversarial-brief',
        name: 'LegalAdversarialBrief',
        component: () => import('@/modules/workflows/views/legal-department/AdversarialBriefPage.vue'),
        meta: { requiresAuth: true, title: 'Adversarial Brief' },
      },
      {
        path: 'app/workflows/legal-department/discovery-review',
        name: 'LegalDiscoveryReview',
        component: () => import('@/modules/workflows/views/legal-department/DiscoveryReviewPage.vue'),
        meta: { requiresAuth: true, title: 'Discovery Review' },
      },
      {
        path: 'app/workflows/legal-department/compliance-audit',
        name: 'LegalComplianceAudit',
        component: () => import('@/modules/workflows/views/legal-department/ComplianceAuditPage.vue'),
        meta: { requiresAuth: true, title: 'Compliance Audit' },
      },
      {
        path: 'app/workflows/legal-department/sentinel',
        name: 'LegalPortfolioSentinel',
        component: () => import('@/modules/workflows/views/legal-department/PortfolioSentinelPage.vue'),
        meta: { requiresAuth: true, title: 'Portfolio Sentinel' },
      },
      {
        path: 'app/workflows/legal-department/monte-carlo',
        name: 'LegalMonteCarlo',
        component: () => import('@/modules/workflows/views/legal-department/MonteCarloTrialSimulatorPage.vue'),
        meta: { requiresAuth: true, title: 'Monte Carlo Trial Simulator' },
      },
      {
        path: 'app/workflows/legal-department/matters',
        name: 'LegalMatters',
        component: () => import('@/modules/workflows/views/legal-department/MatterListPage.vue'),
        meta: { requiresAuth: true, title: 'Matters' },
      },
      {
        path: 'app/workflows/legal-department/matters/:matterId',
        name: 'LegalMatterDashboard',
        component: () => import('@/modules/workflows/views/legal-department/MatterDashboard.vue'),
        meta: { requiresAuth: true, title: 'Matter Dashboard' },
      },
      {
        path: 'app/workflows/legal-department/settings',
        name: 'LegalSettings',
        component: () => import('@/modules/workflows/views/legal-department/LegalSettingsPage.vue'),
        meta: { requiresAuth: true, title: 'Legal Settings' },
      },
      {
        path: 'app/ambient',
        name: 'ambient',
