...
/**
 * Organizations endpoints at /auth/organizations.
 * Mirrors the /admin/organizations controller so that other products
 * can call a single Auth API base URL for all auth-related operations.
 */
@ApiTags('Organizations (Auth)')
@Controller('auth/organizations')
@UseGuards(JwtAuthGuard)
@ApiBearerAuth()
export class AuthOrganizationsController {
