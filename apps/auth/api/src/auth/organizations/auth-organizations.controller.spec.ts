...
import {
  ...
  Organization,
} from '../../admin/organizations/organizations.service';
...
describe('AuthOrganizationsController', () => {
  let controller: AuthOrganizationsController;
  ...
  beforeEach(async () => {
    ...
    controller = module.get<AuthOrganizationsController>(
      AuthOrganizationsController,
    );
  });

  describe('findAll (GET /auth/organizations)', () => {
  ...
  describe('getStats (GET /auth/organizations/stats)', () => {
    it('should return organization statistics', async () => {
      mockOrganizationsService.getStats.mockResolvedValue({ total: 5 });
  ...
  describe('findOne (GET /auth/organizations/:slug)', () => {
  ...
  describe('create (POST /auth/organizations)', () => {
  ...
  describe('update (PUT /auth/organizations/:slug)', () => {
  ...
  describe('delete (DELETE /auth/organizations/:slug)', () => {
