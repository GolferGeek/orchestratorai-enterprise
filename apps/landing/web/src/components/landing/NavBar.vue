  ...
  <nav class="navbar" :class="{ scrolled: isScrolled }">
    <div class="navbar-inner container">
      ...
      <div class="nav-actions">
        ...
        <a :href="commandUrl" class="btn btn-secondary nav-login">Log In</a>
        <a :href="commandUrl" class="btn btn-primary nav-cta">Get Started</a>
      </div>
    ...
    <div v-if="mobileOpen" class="nav-mobile-menu" @click="mobileOpen = false">
      ...
      <div class="mobile-actions">
        <a :href="commandUrl" class="btn btn-secondary">Log In</a>
        <a :href="commandUrl" class="btn btn-primary">Get Started</a>
      </div>
    </div>
  </nav>
</template>
