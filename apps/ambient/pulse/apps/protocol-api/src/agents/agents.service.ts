...
export class AgentsService implements OnModuleInit {
  ...
  async onModuleInit(): Promise<void> {
    ...
    const knownAgents = [
      { name: 'ResearchHub', url: 'http://localhost:4001' },
      { name: 'MarketPulse', url: 'http://localhost:4002' },
      { name: 'SunStream', url: 'http://localhost:4007' },
      { name: 'Ascentek', url: 'http://localhost:4008' },
    ];
