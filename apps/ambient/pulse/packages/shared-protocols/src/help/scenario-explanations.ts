...
export const SUNSTREAM_SCENARIOS: ScenarioExplanation[] = [
  ...
  },
  {
    ...
    whatToVerify: [
      ...
      'Run this scenario on BOTH ports (4017 and 4018) to see each ecosystem\'s perspective',
    ],
  },
  {
    id: 12,
...
export const ASCENTEK_SCENARIOS: ScenarioExplanation[] = [
  ...
  },
  {
    ...
    whatToVerify: [
      ...
      'The actual HTTP call to localhost:4007 (SunStream) is visible in the transport step',
      'Quality complaint data comes from quality-complaints.json',
      'Run the same scenario on SunStream (port 4017) to see the receiving side',
    ],
  },
  {
    id: 12,
