...
const orgColorClass = (org: string): string => {
  ...
  if (org.includes('SunStream')) return 'text-emerald-400';
  if (org.includes('AgriBank')) return 'text-amber-400';
  return 'text-slate-400';
};

const orgBgClass = (org: string): string => {
  if (org.includes('FCS')) return 'bg-blue-950/20 border-blue-800/30';
  if (org.includes('SunStream')) return 'bg-emerald-950/20 border-emerald-800/30';
  if (org.includes('AgriBank')) return 'bg-amber-950/20 border-amber-800/30';
