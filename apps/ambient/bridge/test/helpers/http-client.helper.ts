...
export const SERVICE_BASE_URLS = {
  protocolApi: 'http://localhost:4000',
  sunstream: 'http://localhost:4007',
  ascentek: 'http://localhost:4008',
} as const;
 ...
 *
 * @param baseUrl - Base URL of the service under test (e.g. 'http://localhost:4000')
 */
