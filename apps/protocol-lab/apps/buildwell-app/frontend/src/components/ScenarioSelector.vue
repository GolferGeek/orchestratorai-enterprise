    ...
    <div class="flex items-center justify-between mb-3">
      <div class="flex items-center gap-3">
        ...
        <span class="text-sm font-bold text-gray-100 tracking-wide">
          BuildWell Fishbowl — Manufacturing Supply Chain
        </span>
        <span class="text-xs text-gray-500">Port 6408</span>
      </div>
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs text-gray-600">Agents: Apex OEM · Buildwell · AlloyTech Supply</span>
