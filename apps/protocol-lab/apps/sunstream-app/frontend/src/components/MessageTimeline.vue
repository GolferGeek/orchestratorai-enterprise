...
const orgColor = (name: string): string => {
  if (name.includes('fcs') || name.includes('FCS')) return 'text-blue-400';
  if (name.includes('sunstream') || name.includes('SunStream')) return 'text-emerald-400';
  if (name.includes('agribank') || name.includes('AgriBank')) return 'text-amber-400';
  if (name.includes('new-association')) return 'text-violet-400';
  return 'text-slate-400';
};

const orgBorderColor = (name: string): string => {
  if (name.includes('fcs') || name.includes('FCS')) return 'border-l-blue-500';
  if (name.includes('sunstream') || name.includes('SunStream')) return 'border-l-emerald-500';
  if (name.includes('agribank') || name.includes('AgriBank')) return 'border-l-amber-500';
