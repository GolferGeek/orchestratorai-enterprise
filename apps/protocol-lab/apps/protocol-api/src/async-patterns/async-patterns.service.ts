...
const RESEARCH_HUB_URL = `http://localhost:${process.env.PROTOCOL_LAB_RESEARCH_HUB_PORT ?? '6403'}`;
const MARKET_PULSE_URL = `http://localhost:${process.env.PROTOCOL_LAB_MARKET_PULSE_PORT ?? '6404'}`;
const CONTENT_FORGE_URL = `http://localhost:${process.env.PROTOCOL_LAB_CONTENT_FORGE_PORT ?? '6405'}`;
