...
const SCENARIOS: DemoScenario[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        narration: 'ResearchHub is discovered at localhost:6403/.well-known/agent.json. It advertises capabilities: research-analysis, category-scanning, narrative-generation.',
      ...
      },
      {
        ...
        narration: 'MarketPulse is discovered at localhost:6404/.well-known/agent.json. It advertises capabilities: trend-detection, feed-aggregation, signal-scoring.',
