...
/**
 * Bridges the shared @orchestratorai/auth-client guards into Compose's DI graph.
 *
 ...
 * Compose already provides the concrete implementations via AuthModule (planes
