...
// Frontend analytics telemetry — no-op in dev; receives events from compose
// callers (including pre-login pages). Keeping this public avoids 401 spam
// from unauthenticated pages sending tracking events.
@Public()
