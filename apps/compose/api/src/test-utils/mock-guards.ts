...
/**
 * Shared test helpers for overriding compose-api's auth guards in jest.
 *
 * Every compose-api controller spec that mounts a guarded controller via
 ...
 *
 * This helper is compose-api-local. Admin-api and forge-api each have their
 * own equivalents. All three will be consolidated into packages/auth-client/
 * during the remote-auth unification (Phase 2).
 */
