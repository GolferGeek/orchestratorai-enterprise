...
The LLM service provides a helper that automatically captures thinking content when the model supports extended thinking (e.g., Claude with `thinking` block type). The helper:
