...
|----------|-------------|
| Document Onboarding | `.claude/skills/forge-document-onboarding-browser-skill/` |
| Contract Review | `.claude/skills/forge-contract-review-browser-skill/` |
| Legal Research | `.claude/skills/forge-legal-research-browser-skill/` |
| Due Diligence | `.claude/skills/forge-due-diligence-browser-skill/` |
| Adversarial Brief | `.claude/skills/forge-adversarial-brief-browser-skill/` |
| Compliance Audit | `.claude/skills/forge-compliance-audit-browser-skill/` |
| Monte Carlo | `.claude/skills/forge-monte-carlo-browser-skill/` |
| Matters (Persistent Case Team) | `.claude/skills/forge-matters-browser-skill/` |
| Deal Memo | `.claude/skills/forge-deal-memo-browser-skill/` |
| Discovery Review | `.claude/skills/forge-discovery-review-browser-skill/` |
| Deposition Prep | `.claude/skills/forge-deposition-prep-browser-skill/` |
| Cross-Exam Simulation | `.claude/skills/forge-cross-exam-browser-skill/` |
| Sentinel | `.claude/skills/forge-sentinel-browser-skill/` |
