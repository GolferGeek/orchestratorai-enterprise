...
|----------|-------------|-------|
| Legal Department | `.Codex/skills/forge-legal-department-browser-skill/` | `/app/agents/legal-department` |
| Contract Review (deep) | `.Codex/skills/forge-contract-review-browser-skill/` | `/app/agents/legal-department/contract-review` |
...
```
Read: /Users/golfergeek/projects/orchAI/orchestratorai-enterprise/.Codex/skills/forge-legal-department-browser-skill/where.md
```
