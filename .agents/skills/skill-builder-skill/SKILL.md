...
description: Guide creation of new Codex Skills following best practices and patterns. Use when creating new skills, extending Codex's capabilities, or packaging domain expertise into reusable skills. Keywords: create skill, build skill, new skill, skill creation, skill development.
...
This skill guides the creation of new Codex Skills, ensuring they follow best practices, proper structure, and integration patterns. It helps package domain expertise into discoverable, composable capabilities.
...
- `description`: Required, max 1024 characters
  ...
  - Be specific, not vague
- `allowed-tools`: Optional, restrict which tools Codex can use
