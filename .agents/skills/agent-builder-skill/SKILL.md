...
description: Guide creation of new Codex Agents following best practices and patterns. Use when creating new agents, extending agent capabilities, or packaging domain expertise into autonomous agents. Keywords: create agent, build agent, new agent, agent creation, agent development.
...
This skill guides the creation of new Codex Agents, ensuring they follow best practices, proper structure, mandatory skill references, and integration patterns. It helps package domain expertise into discoverable, autonomous agents.
...
2. When should Codex use this agent? (triggers)
...
**Create agent file:**
```bash
touch .Codex/agents/<agent-name>.md
```
