...
# Protocol Lab: 6400 (web), 6402-6408 (microservices), 6409-6410 (fishbowl UIs)
PORTS="${BASE}000 ${BASE}100 ${BASE}101 ${BASE}102 ${BASE}150 ${BASE}200 ${BASE}201 ${BASE}300 ${BASE}301 ${BASE}400 ${BASE}402 ${BASE}403 ${BASE}404 ${BASE}405 ${BASE}406 ${BASE}407 ${BASE}408 ${BASE}409 ${BASE}410 ${BASE}500 ${BASE}501 ${BASE}600 ${BASE}601 ${BASE}900 ${BASE}901"
...
start_servers() {
  ...
  npx concurrently --kill-others \
    -c "red,yellow,yellow,blue,blue,green,green,magenta,magenta,cyan,cyan,white,white,gray,#ff69b4" \
    -n "auth,admin-api,admin-web,forge-api,forge-web,compose-api,compose-web,pulse-api,pulse-web,bridge-api,bridge-web,flow-api,flow-web,command,protocol-lab" \
    "npm run dev:auth" \
