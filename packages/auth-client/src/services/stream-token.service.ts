...
/**
 * Minimal user shape required to issue a stream token.
 * Products pass their own user DTO (e.g. SupabaseAuthUserDto) which satisfies
 * this interface structurally.
 */
export interface IssueTokenUser {
  id: string;
  email?: string;
  role?: string;
}
